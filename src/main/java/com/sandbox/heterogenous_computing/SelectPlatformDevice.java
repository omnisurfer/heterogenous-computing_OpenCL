 ...
 * @author danielrowan
 */
public class SelectPlatformDevice {
    public static void main(String args[]) throws Exception {
        
    }
    
    public static int selectPlatform(CLPlatform platforms[]) throws Exception {
        System.out.println("SelectPlatform()");                                     
            ...
            while(running)                        
            {
                ...
                System.out.print("Select compute platform, e/E to exit: ");
                if( in.hasNextInt() )
                {
                    int inIndex = in.nextInt();

                    if(inIndex >= 0 && inIndex <= platforms.length - 1)
                    {
    ...
    private static void listPlatforms(CLPlatform platforms[])
    {
        for(int i = 0; i < platforms.length; ++i)          
        {   
            System.out.println(
                    "Platform Index: " + i + " - " + platforms[i]
            );
            /*
            System.out.println(
                String.format(
